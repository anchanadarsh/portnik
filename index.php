    ...
    <?php include'_partial/header.php'?>
        <section class="mastwrap signature-adler">
            <div class="inner-wrap">
                ...
                <section class="intro-01 signature-adler">

                    <section class="filter-notification signature-adler">
                        <a class="font3bold" href="#">Show Filters</a>
                    </section>
                    ...
                    <section id="works-container" class="works-container signature-adler works-masonry-container clearfix white-bg works-thumbnails-view">
                        ...
                        <div class="works-item signature-adler ImageWrapper works-item-one-third-spaced zoom animation">
                            <img data-no-retina alt="" title="" class="img-responsive" src="images/portfolio/animation/dancing%20glass.gif" />
                            <a class="venobox" data-gall="portfolio-gallery-anim" href="images/portfolio/animation/dancing%20glass.gif">
                                <div class="works-item-inner ImageOverlayHe">
                                    <p class="valign text-center"><span class="white font3">Dancing Glass</span></p>
                                </div>
                            </a>
                        </div>
                        <div class="works-item signature-adler ImageWrapper works-item-one-third-spaced zoom animation">
                            <img data-no-retina alt="" title="" class="img-responsive" src="images/portfolio/animation/giphy.gif" />
                            <a class="venobox" data-gall="portfolio-gallery-anim" href="images/portfolio/animation/giphy.gif">
                                <div class="works-item-inner ImageOverlayHe">
                                    <p class="valign text-center"><span class="white font3">Giphy</span></p>
                                </div>
                            </a>
                        </div>

                        <div class="works-item signature-adler ImageWrapper works-item-one-third-spaced zoom 3d">
                            <img data-no-retina alt="" title="" class="img-responsive" src="images/portfolio/3d/Chikasha%20Chataracter%20Design.jpg" />
                            <a class="venobox" data-gall="portfolio-gallery-3d" href="images/portfolio/3d/Chikasha%20Chataracter%20Design.jpg">
                                <div class="works-item-inner ImageOverlayHe">
                                    <p class="valign text-center"><span class="white font3">Chiksha Character Design</span></p>
                                </div>
                            </a>
                        </div>
                        <div class="works-item signature-adler ImageWrapper works-item-one-third-spaced zoom 3d">
                            <img data-no-retina alt="" title="" class="img-responsive" src="images/portfolio/3d/Oh%20Boy.jpg" />
                            <a class="venobox" data-gall="portfolio-gallery-3d" href="images/portfolio/3d/Oh%20Boy.jpg">
                                <div class="works-item-inner ImageOverlayHe">
                                    <p class="valign text-center"><span class="white font3">Oh Boy</span></p>
                                </div>
                            </a>
                        </div>
                        <div class="works-item signature-adler ImageWrapper works-item-one-third-spaced zoom 3d">
                            <img data-no-retina alt="" title="" class="img-responsive" src="images/portfolio/3d/Vile%20Character%20Design.jpg" />
                            <a class="venobox" data-gall="portfolio-gallery-3d" href="images/portfolio/3d/Vile%20Character%20Design.jpg">
                                <div class="works-item-inner ImageOverlayHe">
                                    <p class="valign text-center"><span class="white font3">Vile Character Design</span></p>
                                </div>
                            </a>
                        </div>
-->
